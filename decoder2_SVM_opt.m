...
for start_bin_opt = 11:18
	for end_bin_opt = start_bin_opt+2:20
		
	fprintf("Current bins: %d-%d\n", start_bin_opt, end_bin_opt);
		...
		for i=1:6
			...
			feature_selection, algo, p_value_threshold, start_bin_opt, end_bin_opt);
			...
			training_samples_per_target,test_samples_per_target,targets, train_idx, i, start_bin_opt, end_bin_opt);
		...
		if algo_accuracy_dist.mean > max_accuracy
			...
			opt_start_bin = start_bin_opt;
			opt_end_bin = end_bin_opt;
		elseif (algo_accuracy_dist.mean == max_accuracy) & (algo_accuracy_dist.sigma < max_accuracy_std || max_accuracy_std == 0)
			max_accuracy = algo_accuracy_dist.mean;
			max_accuracy_std = algo_accuracy_dist.sigma;
			opt_start_bin = start_bin_opt;
			opt_end_bin = end_bin_opt;
